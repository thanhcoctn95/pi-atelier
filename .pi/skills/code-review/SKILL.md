...
The issue tracker should have been provided to you — run `/skill:setup-matt-pocock-skills` if `.pi/docs/agents/issue-tracker.md` is missing.
...
1. Issue references in the commit messages (`#123`, `Closes #45`, GitLab `!67`, etc.) — fetch via the workflow in `.pi/docs/agents/issue-tracker.md`.
