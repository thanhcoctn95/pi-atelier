...
When exploring the codebase, read `.pi/docs/CONTEXT.md` (if it exists) to get a clear mental model of the relevant modules, and check ADRs in the area you're touching.
